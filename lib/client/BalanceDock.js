...
export function BalanceDock({ useProjection, t }) {
    ...
    const openChart = useCallback(() => {
        ...
        if (el !== null)
            setTailX(el.offsetLeft + el.offsetWidth / 2);
